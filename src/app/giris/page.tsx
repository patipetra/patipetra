    ...
    <div className="min-h-screen grid lg:grid-cols-[.9fr_1.1fr]">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-[#2F2622] p-14 relative overflow-hidden">
        ...
        <div className="relative z-10 my-10">
          ...
          <p className="text-sm text-white/50 leading-relaxed mb-7">Pet profili, veteriner, sahiplendirme ve mağaza — ücretsiz başla.</p>
          <div className="flex flex-col gap-3">
            {[{i:'🐾',t:'Pet Pasaport',d:'Aşı, muayene geçmişi tek yerde'},{i:'🩺',t:'Veteriner İletişimi',d:'Doğrulanmış vet, hızlı yanıt'},{i:'📢',t:'81 İlde İlan',d:'Güvenli sahiplendirme sistemi'},{i:'🛍',t:'Premium Mağaza',d:'Vet önerili ürünler'}].map(f=>(
